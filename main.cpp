...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Soumya"<<endl;
        string phrase = "Good Morning Soumya";
        ...
        cout<< "Good Afternoon Soumya"<<endl;
        string phrase = "Good Afternoon Soumya";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Soumya"<<endl;
        string phrase = "Good Evening Soumya";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE SOUMYA"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE SOUMYA";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="soumya")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Soumya"<<endl<<endl;

                string phrase = "How can i help you Soumya";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"I'm a personal assistant created by Soumya !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Soumya !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"Good Bye Soumya, see you soon!"<<endl;
                    string phrase = "Good Bye Soumya, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
